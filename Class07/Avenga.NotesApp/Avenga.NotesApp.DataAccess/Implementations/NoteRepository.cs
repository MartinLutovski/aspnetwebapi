...
namespace Avenga.NotesApp.DataAccess.Implementations
{
    public class NoteRepository : IRepository<Note>
    {
        ...
        {
            // Include will join note and user tables and include User data in the query result as well
        ...
        public void Update(Note entity)
        {
            ...
            _notesAppDbContext.SaveChanges(); // This is when the changes are actually saved to the database
        }
    }
}
